        ...
        .cors(cors -> {
                    cors.configurationSource(new CorsConfigurationSource() {
                        ...
                        public CorsConfiguration getCorsConfiguration(HttpServletRequest request) {
                            ...
                            cfg.setAllowedOriginPatterns(Collections.singletonList("https://angelic-nature-production-1e8f.up.railway.app"));//"https://8081-aeecdbdbcbbfcaabecebeddbadd.premiumproject.examly.io")) 
