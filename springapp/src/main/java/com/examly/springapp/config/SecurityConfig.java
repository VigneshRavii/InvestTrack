        ...
        .cors(cors -> {
                    cors.configurationSource(new CorsConfigurationSource() {
                        ...
                        public CorsConfiguration getCorsConfiguration(HttpServletRequest request) {
                            ...
                            cfg.setAllowedOriginPatterns(Collections.singletonList(("https://8081-bacdabcaefbbfcaabecebeddbadd.premiumproject.examly.io")));//"https://8081-aeecdbdbcbbfcaabecebeddbadd.premiumproject.examly.io")) 
